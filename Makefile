...
# Project:  CS123.pro
# Template: app
# Command: /usr/lib/qt5/bin/qmake -o Makefile CS123.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug
#############################################################################
...
COMPRESS      = gzip -9f
DISTNAME      = CS1231.0.0
DISTDIR = /gpfs/main/home/jmina/course/cs1230/projectsIntersect/.tmp/CS1231.0.0
LINK          = g++
LFLAGS        = -no-pie
...
SOURCES       = brush/Brush.cpp \
		...
		scenegraph/ImplicitShape.cpp qrc_resources.cpp \
		moc_Canvas2D.cpp \
...
DIST          = shaders/normals/normals.vert \
		...
		scenegraph/ImplicitShape.h brush/Brush.cpp \
		brush/ConstantBrush.cpp \
		brush/LinearBrush.cpp \
		brush/QuadraticBrush.cpp \
		brush/SmudgeBrush.cpp \
...
distdir: FORCE
	...
	$(COPY_FILE) --parents brush/Brush.h brush/ConstantBrush.h brush/LinearBrush.h brush/QuadraticBrush.h brush/SmudgeBrush.h camera/Camera.h camera/OrbitingCamera.h camera/CamtransCamera.h camera/QuaternionCamera.h filter/filterscale.h filter/filtersharpen.h scenegraph/Cube.h scenegraph/Scene.h scenegraph/OpenGLScene.h scenegraph/ShapesScene.h scenegraph/SceneviewScene.h scenegraph/RayScene.h scenegraph/openglshape.h ui/Canvas2D.h ui/SupportCanvas2D.h ui/SupportCanvas3D.h ui/Settings.h ui/mainwindow.h ui/Databinding.h ui_mainwindow.h gl/shaders/Shader.h gl/GLDebug.h gl/shaders/ShaderAttribLocations.h gl/datatype/VBOAttribMarker.h gl/datatype/VBO.h gl/datatype/IBO.h gl/datatype/VAO.h gl/datatype/FBO.h gl/textures/Texture.h gl/textures/Texture2D.h gl/textures/TextureParameters.h gl/textures/TextureParametersBuilder.h gl/textures/RenderBuffer.h gl/textures/DepthBuffer.h gl/shaders/CS123Shader.h gl/util/FullScreenQuad.h lib/CS123XmlSceneParser.h lib/CS123SceneData.h lib/CS123ISceneParser.h lib/ResourceLoader.h glew-1.10.0/include/GL/glew.h lib/RGBA.h scenegraph/Cone.h scenegraph/Sphere.h scenegraph/Cylinder.h filter/filterblur.h filter/Filter.h filter/filterutils.h filter/FilterGray.h filter/edgedetection.h scenegraph/Cube_Implicit.h scenegraph/Sphere_Implicit.h scenegraph/Cone_Implicit.h scenegraph/Cylinder_Implicit.h scenegraph/ImplicitShape.h $(DISTDIR)/
	$(COPY_FILE) --parents brush/Brush.cpp brush/ConstantBrush.cpp brush/LinearBrush.cpp brush/QuadraticBrush.cpp brush/SmudgeBrush.cpp camera/OrbitingCamera.cpp camera/CamtransCamera.cpp camera/QuaternionCamera.cpp filter/filterscale.cpp filter/filtersharpen.cpp scenegraph/Cube.cpp scenegraph/Scene.cpp scenegraph/OpenGLScene.cpp scenegraph/ShapesScene.cpp scenegraph/SceneviewScene.cpp scenegraph/RayScene.cpp scenegraph/openglshape.cpp ui/Canvas2D.cpp ui/SupportCanvas2D.cpp ui/SupportCanvas3D.cpp ui/Settings.cpp ui/mainwindow.cpp ui/Databinding.cpp lib/CS123XmlSceneParser.cpp lib/ResourceLoader.cpp gl/shaders/Shader.cpp gl/GLDebug.cpp gl/datatype/VBOAttribMarker.cpp gl/datatype/VBO.cpp gl/datatype/IBO.cpp gl/datatype/VAO.cpp gl/datatype/FBO.cpp gl/textures/Texture.cpp gl/textures/Texture2D.cpp gl/textures/TextureParameters.cpp gl/textures/TextureParametersBuilder.cpp gl/textures/RenderBuffer.cpp gl/textures/DepthBuffer.cpp gl/shaders/CS123Shader.cpp gl/util/FullScreenQuad.cpp main.cpp glew-1.10.0/src/glew.c lib/RGBA.cpp scenegraph/Cone.cpp scenegraph/Sphere.cpp scenegraph/Cylinder.cpp filter/Filter.cpp filter/filterblur.cpp filter/filterutils.cpp filter/FilterGray.cpp filter/edgedetection.cpp scenegraph/Cube_Implicit.cpp scenegraph/Sphere_Implicit.cpp scenegraph/Cone_Implicit.cpp scenegraph/Cylinder_Implicit.cpp scenegraph/ImplicitShape.cpp $(DISTDIR)/
...
moc_Canvas2D.cpp: ui/SupportCanvas2D.h \
		...
		moc_predefs.h \
		/usr/lib/qt5/bin/moc
	/usr/lib/qt5/bin/moc $(DEFINES) --include /gpfs/main/home/jmina/course/cs1230/projectsIntersect/moc_predefs.h -I/usr/lib/x86_64-linux-gnu/qt5/mkspecs/linux-g++ -I/gpfs/main/home/jmina/course/cs1230/projectsIntersect -I/gpfs/main/home/jmina/course/cs1230/projectsIntersect/glm -I/gpfs/main/home/jmina/course/cs1230/projectsIntersect/brush -I/gpfs/main/home/jmina/course/cs1230/projectsIntersect/camera -I/gpfs/main/home/jmina/course/cs1230/projectsIntersect/lib -I/gpfs/main/home/jmina/course/cs1230/projectsIntersect/scenegraph -I/gpfs/main/home/jmina/course/cs1230/projectsIntersect/ui -I/gpfs/main/home/jmina/course/cs1230/projectsIntersect/glew-1.10.0/include -I/usr/include/x86_64-linux-gnu/qt5 -I/usr/include/x86_64-linux-gnu/qt5/QtOpenGL -I/usr/include/x86_64-linux-gnu/qt5/QtWidgets -I/usr/include/x86_64-linux-gnu/qt5/QtGui -I/usr/include/x86_64-linux-gnu/qt5/QtXml -I/usr/include/x86_64-linux-gnu/qt5/QtCore -I/usr/include/c++/8 -I/usr/include/x86_64-linux-gnu/c++/8 -I/usr/include/c++/8/backward -I/usr/lib/gcc/x86_64-linux-gnu/8/include -I/usr/local/include -I/usr/lib/gcc/x86_64-linux-gnu/8/include-fixed -I/usr/include/x86_64-linux-gnu -I/usr/include ui/Canvas2D.h -o moc_Canvas2D.cpp
...
openglshape.o: scenegraph/openglshape.cpp scenegraph/openglshape.h \
		glew-1.10.0/include/GL/glew.h \
		gl/datatype/VBO.h \
		gl/datatype/VBOAttribMarker.h \
		gl/shaders/ShaderAttribLocations.h \
		...
		glm/detail/func_integer.hpp \
		glm/detail/func_integer.inl
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o openglshape.o scenegraph/openglshape.cpp
...
Cone.o: scenegraph/Cone.cpp scenegraph/Cone.h \
		scenegraph/openglshape.h \
		glew-1.10.0/include/GL/glew.h \
		gl/datatype/VBO.h \
		gl/datatype/VBOAttribMarker.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o Cone.o scenegraph/Cone.cpp
...
Cylinder.o: scenegraph/Cylinder.cpp scenegraph/Cylinder.h \
		scenegraph/openglshape.h \
		glew-1.10.0/include/GL/glew.h \
		gl/datatype/VBO.h \
		gl/datatype/VBOAttribMarker.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o Cylinder.o scenegraph/Cylinder.cpp
...
FilterGray.o: filter/FilterGray.cpp filter/FilterGray.h \
		filter/Filter.h \
		lib/RGBA.h \
		ui/Canvas2D.h \
		ui/SupportCanvas2D.h \
		...
		brush/QuadraticBrush.h \
		brush/SmudgeBrush.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o FilterGray.o filter/FilterGray.cpp

edgedetection.o: filter/edgedetection.cpp filter/edgedetection.h \
		filter/Filter.h \
		lib/RGBA.h \
		ui/Canvas2D.h \
		ui/SupportCanvas2D.h \
		...
		filter/FilterGray.h \
		filter/filterutils.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o edgedetection.o filter/edgedetection.cpp

Cube_Implicit.o: scenegraph/Cube_Implicit.cpp scenegraph/Cube_Implicit.h \
		scenegraph/ImplicitShape.h \
		glm/glm.hpp \
		glm/detail/_fixes.hpp \
		glm/fwd.hpp \
		...
		glm/detail/func_integer.hpp \
		glm/detail/func_integer.inl
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o Cube_Implicit.o scenegraph/Cube_Implicit.cpp

Sphere_Implicit.o: scenegraph/Sphere_Implicit.cpp scenegraph/Sphere_Implicit.h \
		scenegraph/ImplicitShape.h \
		glm/glm.hpp \
		glm/detail/_fixes.hpp \
		glm/fwd.hpp \
		...
		glm/detail/func_integer.hpp \
		glm/detail/func_integer.inl
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o Sphere_Implicit.o scenegraph/Sphere_Implicit.cpp

Cone_Implicit.o: scenegraph/Cone_Implicit.cpp scenegraph/Cone_Implicit.h \
		scenegraph/ImplicitShape.h \
		glm/glm.hpp \
		glm/detail/_fixes.hpp \
		glm/fwd.hpp \
		...
		gl/datatype/VBO.h \
		gl/datatype/VBOAttribMarker.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o Cone_Implicit.o scenegraph/Cone_Implicit.cpp

Cylinder_Implicit.o: scenegraph/Cylinder_Implicit.cpp scenegraph/Cylinder_Implicit.h \
		scenegraph/ImplicitShape.h \
		glm/glm.hpp \
		glm/detail/_fixes.hpp \
		glm/fwd.hpp \
		...
		glm/detail/func_integer.hpp \
		glm/detail/func_integer.inl
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o Cylinder_Implicit.o scenegraph/Cylinder_Implicit.cpp
