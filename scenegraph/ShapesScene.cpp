...
void ShapesScene::renderGeometry() {
    ...
    switch (settings.shapeType)
    {
        ...
        case SHAPE_CONE:
        {
            ...
            std::unique_ptr<Cone> m_cone (new Cone(radius, height, theTip, settings.shapeParameter2, settings.shapeParameter1));
            ...
            std::unique_ptr<OpenGLShape> m_square = std::make_unique<OpenGLShape>();
        ...
        case SHAPE_CUBE:
        {
            ...
            std::vector<float> vert1 = {-0.5f, -0.5f, -0.5f};
            std::vector<float> vert2 = {-0.5f, +0.5f, -0.5f};
            std::vector<float> vert3 = {+0.5f, -0.5f, -0.5f};
            std::vector<float> vert4 = {+0.5f, +0.5f, -0.5f};

            std::vector<float> vert8 = {-0.5f, -0.5f, +0.5f};
            std::vector<float> vert7 = {-0.5f, +0.5f, +0.5f};
            std::vector<float> vert6 = {+0.5f, -0.5f, +0.5f};
            std::vector<float> vert5 = {+0.5f, +0.5f, +0.5f};

            std::unique_ptr<Cube> m_cube (new Cube(vert1, vert2, vert3, vert4, vert5, vert6, vert7, vert8, settings.shapeParameter1));
            m_cube->MakeCube();
        ...
        case SHAPE_SPHERE:
        {
            ...
            std::unique_ptr<Sphere> m_sphere (new Sphere(theCenter, radius, settings.shapeParameter2, settings.shapeParameter1));
            m_sphere->MakeSphere();
            break;
        }
        ...
        case SHAPE_CYLINDER:
        {
            ...
            std::unique_ptr<Cylinder> m_cylinder (new Cylinder(radius, 1, theCenter, settings.shapeParameter2, settings.shapeParameter1));
