...
void SupportCanvas3D::paintGL() {
    ...
    // <<---- at this point m_list of
    // m_sceneviewScene/m_currentScene is NOT correct
}
...
void SupportCanvas3D::loadSceneviewSceneFromParser(CS123XmlSceneParser &parser) {
    m_sceneviewScene = std::make_unique<SceneviewScene>();
    Scene::parse(m_sceneviewScene.get(), &parser);   // <<---- at this point m_list of
    m_settingsDirty = true;                          // m_sceneviewScene/m_currentScene is correct
}
